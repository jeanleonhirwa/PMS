...
class ProjectDialog(customtkinter.CTkToplevel):
    def __init__(self, master, title, poppins_font, poppins_bold_font, project=None):
        ...
        self.name_label = customtkinter.CTkLabel(self, text="Name:", font=poppins_font)
        self.name_label.grid(row=0, column=0, padx=20, pady=10, sticky="w")
        self.name_entry = customtkinter.CTkEntry(self, width=250, font=poppins_font)
        self.name_entry.grid(row=0, column=1, padx=20, pady=10)

        self.description_label = customtkinter.CTkLabel(self, text="Description:", font=poppins_font)
        self.description_label.grid(row=1, column=0, padx=20, pady=10, sticky="w")
        self.description_entry = customtkinter.CTkEntry(self, width=250, font=poppins_font)
        ...
        self.ok_button = customtkinter.CTkButton(self, text="OK", command=self.ok_event, font=poppins_font)
        self.ok_button.grid(row=2, column=0, padx=20, pady=20, sticky="e")

        self.cancel_button = customtkinter.CTkButton(self, text="Cancel", command=self.cancel_event, font=poppins_font)
        self.cancel_button.grid(row=2, column=1, padx=20, pady=20, sticky="w")

class TaskDialog(customtkinter.CTkToplevel):
    def __init__(self, master, title, data_manager, poppins_font, poppins_bold_font, task=None):
        super().__init__(master)
        self.title(title)
        ...
        self.due_date_label = customtkinter.CTkLabel(self, text="Due Date:", font=poppins_font)
        self.due_date_label.grid(row=1, column=0, padx=20, pady=10, sticky="w")
        self.due_date_entry = customtkinter.CTkEntry(self, width=250, font=poppins_font)
        self.due_date_entry.grid(row=1, column=1, padx=20, pady=10)

        self.project_label = customtkinter.CTkLabel(self, text="Project:", font=poppins_font)
        self.project_label.grid(row=2, column=0, padx=20, pady=10, sticky="w")
        self.project_menu = customtkinter.CTkOptionMenu(self, width=250, values=[], font=poppins_font)
